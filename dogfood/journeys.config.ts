...
export default defineConfig({
  ...
  testMatch: ["{reply,memory,tooluse,rename,twoloops,gitcommit,gitdiff,gitstage,restart,readfile,secondmsg,filestree,distill,folder,archive,multistep,interrupt,contextfiles,context,ai-extra,context-latest,context-isolation,promote-absorb,structure-automerge,kn-propose-merge}/journey.spec.ts"],
