...
| `/loopat/context/knowledge/` | `LOOPAT_HOME/loops/<id>/context/knowledge/`（**per-loop worktree**） | rw | AI 在自己分支 `loop/<id>` 上写并 commit 后停（gated promote，提案在 Context UI 审/合，见 docs/context-flow.md "Gates"） |
