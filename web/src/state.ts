...
export type WorkspaceState = {
  ...
  createLoop: (opts: { title: string; repo?: string; profiles?: string[]; vault?: string; knowledgeRw?: boolean; mountAllLoops?: boolean; backend?: "claude-code" | "pi-agent" }) => Promise<LoopMeta>
...
export function useWorkspaceState(): WorkspaceState {
  ...
  const createLoop = useCallback(async (opts: { title: string; repo?: string; profiles?: string[]; vault?: string; knowledgeRw?: boolean; mountAllLoops?: boolean; backend?: "claude-code" | "pi-agent" }) => {
